...
@section('content')
                        ...
                        <div style="width: 16.66%;border:1px solid rgb(243, 243, 243)" class="mb-4">
                            <div class="productCard">
                                <div class="view overlay">
                                    <form action="{{url('/transcation/addproduct', )}}" method="POST">
                                        @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-center">Rs.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div style="overflow-y:auto;min-height:53vh;max-height:53vh" class="mb-3">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <form action="{{url('/transcation/removeproduct')}}"
                                            method="POST">
                                            @csrf
                                    ...
                                    <td class="font-weight-bold">
                                        <form action="{{url('/transcation/decreasecart')}}"
                                        ...
                                        <form action="{{url('/transcation/increasecart')}}"
                                            method="POST" style='display:inline;'>
                                            @csrf
                    ...
                    <table class="table table-sm table-borderless">
                        <tr>
                            ...
                            <th width="40%" class="text-right">Rs.
                                </th>
                        </tr>
                        {{-- <tr>
                            <th>
                        ...
                        <tr>
                            <th>Total</th>
                            <th class="text-right font-weight-bold">Rs.
                                </th>
                        </tr>
                    </table>
                    <div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-sm table-borderless">
                        <tr>
                            <th width="60%">Sub Total</th>
                            <th width="40%" class="text-right">Rs. </th>
                        </tr>
                    ...
                    <h1 class="font-weight-bold mb-5">Rs. </h1>
                    <input id="totalHidden" type="hidden" name="totalHidden" value="" />

                    <h3 class="font-weight-bold">pay :</h3>
                    <h1 class="font-weight-bold mb-5" id="pembayaran"></h1>

                    <h3 class="font-weight-bold text-primary">return:</h3>
    ...
    <script>
        toastr.success(
            'your have successfully purchased items '
        )
    ...
    <script>
        ...
        oke.oninput = function () {
            ...
            document.getElementById("pembayaran").innerHTML = bayar ? 'Rs ' + rupiah(bayar) + ',00' : 'Rp ' + 0 +
                ',00';
            document.getElementById("kembalian").innerHTML = hasil ? 'Rs ' + rupiah(hasil) + ',00' : 'Rp ' + 0 +
                ',00';
