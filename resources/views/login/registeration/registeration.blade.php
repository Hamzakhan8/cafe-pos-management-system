                                ...
                                @endif
                                    ...
                                    <form action="{{route('auth.register')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" value="admin">
                                        </div>
                                        {{-- <div class="form-group ">
                                            <label class="mb-1"><strong>Role</strong></label>
                                            <input type="text"  name="role" class="form-control" value="saleperson">
                                        </div> --}}
                                        <div class="form-group">
                                    ...
                                    <div class="new-account mt-3">
                                        <p>sign in now? <a class="text-primary" href="{{route('auth.login.show')}}">Sign in here</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
